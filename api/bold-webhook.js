...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await sendTelegramNotification({ orderId, totalAmount, paymentMethod, description });
  } catch (err) {
    console.error('Error procesando el webhook de Bold:', err);
  }
};

async function sendTelegramNotification({ orderId, totalAmount, paymentMethod, description }) {
